...
7. Test jouw component lokaal doorlopend. Responsiviteit is eenvoudig want je werkt met container-queries. Test met lighthouse op *accessibility* en *performance*, zorg ook dat je de handmatige tests uitvoert. Je hoeft in deze fase nog geen device- of usertest uit te voeren.
...
10. Als meerdere componenten uit jouw team geïntegreerd zijn plan je een usertest om de werking van jullie systeem te testen. Een user-test heeft een plan (wat wil je testen) en wordt uitgevoerd op personen die i) niet in jouw ontwikkelteam zitten en ii) geen frontender zijn.
