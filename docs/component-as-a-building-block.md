...
N.B.: Zorg er voor dat stap 1 t/m 6 voor woensdag zijn afgerond. Tijdens de les over *the new responsive* wordt aandacht gegeven aan container queries, het is belangrijk dat je de ontwerpfase dan afgerond hebt!
...
5. Maak een HiFi wireframe van de door jou gekozen variatie. Zorg ervoor dat je weet hoe jouw component er uit ziet op verschillende schermgroottes, maak een *responsive design*. [convergeren]
...
7. Test jouw component lokaal doorlopend. Responsiviteit is eenvoudig want je werkt met container-queries. Test op [*accessibility*](https://github.com/fdnd-task/wcag-audit) en [*performance*](https://github.com/fdnd-task/performance-audit). Je hoeft in deze fase nog geen device- of user test uit te voeren.
